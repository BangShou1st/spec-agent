...
import connectionsSource from '@/features/connections/api/connections.ts?raw'
import skillsSource from '@/features/skills/api/skills.ts?raw'
import connectionsStoreSource from '@/features/connections/state/connectionsStore.ts?raw'
import skillsStoreSource from '@/features/skills/state/skillsStore.ts?raw'
