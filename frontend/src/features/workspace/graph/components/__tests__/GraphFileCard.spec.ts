...
import GraphKnowledgeNode from '@/features/workspace/graph/components/GraphKnowledgeNode.vue'
import type { SpecAgentGraphNodeData } from '@/features/workspace/graph/graphProjection'
import type { GraphWorkspaceNodeView } from '@/shared/contracts/types'
