...
import NodeInspector from '@/features/workspace/components/NodeInspector.vue'
...
import { acceptProposal, rejectProposal } from '@/features/workspace/api/graphCommands'
