...
import { capabilityPresentation, completedCountLabel } from '@/features/global-assistant/presentation/capabilityPresentation';
import { GaRunProjection, type GaToolActivity } from '@/features/global-assistant/state/globalAssistantStore';
