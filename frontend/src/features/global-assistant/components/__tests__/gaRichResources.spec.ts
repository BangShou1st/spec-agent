...
import ProjectResourceList from '@/features/global-assistant/components/ProjectResourceList.vue'
import { sanitizeGaResourceRefs } from '@/features/global-assistant/state/globalAssistantStore'
