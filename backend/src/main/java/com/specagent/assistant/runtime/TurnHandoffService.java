...
import com.specagent.assistant.conversation.SteerRejectedException;

import com.specagent.assistant.conversation.PendingTurn;
import com.specagent.assistant.conversation.PendingTurnRepository;
...
public class TurnHandoffService {
    ...
    public AcceptResult acceptSteer(UUID threadId, UUID targetRunId, String rawMessage, GlobalAssistantContextBuilder.UiRequest uiRequest) {
        ...
        lockThread(threadId);
        com.specagent.assistant.conversation.GlobalAssistantRun freshTarget;
        try {
    ...
    @Transactional
    public com.specagent.assistant.conversation.ThreadActivity stopThreadAtomically(UUID threadId) {
        lockThread(threadId);
        ...
        return new com.specagent.assistant.conversation.ThreadActivity(runs.findActiveByThread(threadId), pending.findUnresolvedByThread(threadId));
    }
