...
public class GlobalAssistantSummaryService {
    ...
    public boolean maybeSummarize(UUID threadId, UUID runId) {
        ...
        int alreadySummarized = com.specagent.assistant.conversation.GlobalAssistantConversationWindowPolicy
                .summarizedCount(thread.summaryVersion());
        int chunkSize = com.specagent.assistant.conversation.GlobalAssistantConversationWindowPolicy
                .SUMMARY_CHUNK_SIZE;
        int evictedCount = com.specagent.assistant.conversation.GlobalAssistantConversationWindowPolicy
