...
/**
 * Read-model-neutral failure raised by graph workspace reads.
 *
...
public class GraphWorkspaceQueryException extends RuntimeException {
    ...
    /** Closed, strongly bounded failure reasons for graph workspace reads. */
    public enum Reason {
        /** The requested project does not exist. */
        PROJECT_NOT_FOUND,
        /** The graph failed an integrity/ownership invariant check. */
        INVARIANT_VIOLATION
    }
